...
public class DeviceSettingsActivity extends CollapsingToolbarBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (collapsingToolbar != null) {
            ...
            collapsingToolbar.addView(bannerLayout, 0 /*top position on layer mask*/);
            ...
            if (appBar != null) {
                appBar.addOnOffsetChangedListener((appBarLayout, verticalOffset) -> {
                    ...
                    // float mAlpha = (offsetFraction - 0.8f) / 0.2f; // bAlpha = 0 for offsetFraction <= 0.8
                    // mAlpha = Math.max(0.0f, Math.min(1.0f, mAlpha)); // Clamp between 0 and 1
